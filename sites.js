...
const CHAPTERS = [
  ...
  { key: 'jin', years: '317 — 420 · 东晋', blurb: '爨宝子碑立于东晋义熙元年，云南的石刻留下了爨氏在南中的历史片段。' },
  ...
  { key: 'nanzhao', years: '738 — 902 · 南诏', blurb: '石钟山石窟的王像龛留有南诏世俗人物题材；具体人物身份仍按研究资料审慎标注。' },
...
SITES.push(...[
  ...
  },
  {
    ...
    "initialStatus": "unvisited",
    "lede": "高大的弥勒坐像倚着岩壁。图版保留一侧手部残损与垂足姿态，只画贴近造像的龛壁。",
    "facts": [
      "第171龛大佛开凿于731年，上半身石雕、下部泥塑；与石窟更早的西秦洞窟分开断代。",
      "图版依据现状照片作线描与设色意写，不作为实测图或碑文释读。"
    ],
    "caption": [
      "第171龛弥勒大佛 · 线稿",
    ...
    "protection": {
      ...
      "source": "batch1",
      "scope": "第171龛弥勒大佛",
      "locator": "1961年第一批全国重点文物保护单位名单第39项",
      "scopeSources": [
        {
          "title": "国务院公报 · 第一批国保名单",
          "url": "https://www.gov.cn/gongbao/shuju/1961/gwyb196104.pdf"

...
if (delivery.format !== 'AVIF' || delivery.settings.quality !== 85 || delivery.settings.subsampling !== '4:4:4' || !delivery.transparency) throw new Error('Expected transparent AVIF Q85 with 4:4:4 color sampling.');
...
console.log(`${progress.complete.length}/${queue.count} batch colored plates ready; ${Object.keys(manifest).length} including ${queue.excluded.length} approved existing plates.`);
